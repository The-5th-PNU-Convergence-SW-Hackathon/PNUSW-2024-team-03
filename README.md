...
#### 1.5. 사회적가치 도입 계획
1. 공공기관과의 연계
> - 신원 인증의 신뢰성 강화: 서비스 이용자들의 신원을 인증하는 과정에서 공공 시스템에 기입된 데이터를 활용하여 보다 신뢰할 수 있는 서비스를 제공할 계획입니다. 이로써 사용자들의 정보가 안전하게 관리되고 서비스의 투명성과 신뢰성이 높아질 것입니다.
> - B2G 플랫폼으로의 발전 가능성: 서비스가 발전함에 따라 B2G(Business to Government) 형식으로 정부 기관과의 연계를 통해 공공 서비스를 제공하는 플랫폼으로 확장될 수 있습니다. 이를 통해 공공기관과 협력하여 다양한 공공 서비스를 제공하고 사용자가 쉽고 편리하게 이용할 수 있도록 지원할 수 있습니다.
2. 서비스 범위 확대
...
> 부산광역시 금정구 → 부산광역시 전역 → 국내 전역
> - 서비스 대상 확대: 신원 인증과 범죄예방을 강화하여 대학생을 주 대상으로 시작한 서비스를 만 19세 이상의 성인으로 확대함으로써, 더 넓은 사용자층을 확보하고 서비스의 활성화를 도모할 것입니다. 
3. 향토기업과 지역 대학생 연결
> - 향토기업 홍보: 부산광역시의 향토 기업들이 서비스에 참여하여 투자할 경우, 해당 기업들은 지역민들에게 선한 이미지를 심어줄 수 있습니다. 또한, 기업의 제품을 리워드 보상으로 내세워 홍보 효과를 극대화할 수 있습니다.
> - 대학생과의 상호 이익: 지역의 대학생들은 이러한 기업과의 연결을 통해 다양한 혜택을 얻을 수 있습니다. 기업의 정보에 접근하고 보다 친근하게 다가갈 수 있는 기회를 가지며 활동에 대한 보상도 받을 수 있습니다. 본 서비스는 이러한 상호작용이 선순환하여 지역사회가 상생할 수 있도록 하는 것을 목표로 합니다.

이를 통해 각각의 입장에서 얻을 수 있는 이점은 다음과 같습니다>.
